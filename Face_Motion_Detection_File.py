...
class Window(QMainWindow):
    ...
    def UiComponents(self):
        ...
        self.lcd.setStyleSheet("border-radius : 30;border: 2px solid blue;border-style : double;")
        ...
        self.Maximize = QAction(QtGui.QIcon("./Resources/FullScreen.png"),self.T_Maximize,self)
        self.Maximize.triggered.connect(self.Fun_Maximize)
        self.Maximize.setShortcut("Alt+M")
        self.Maximize.setStatusTip("Enlarge")
    ...
    def Fun_Maximize(self):
        ...
        if(self.grabber.windowzoomsize==1):
            self.Maximize.setIcon(QtGui.QIcon("../Resources/Enlarge.png"))
            self.lcd.move(670,50)
            self.message.move(677,90)
            self.toolbar.setIconSize(QtCore.QSize(63, 35))
            self.Maximize.setStatusTip("Reduce")
            self.Maximize.setToolTip("Reduce")
        else:
            self.Maximize.setIcon(QtGui.QIcon("../Resources/FullScreen.png"))
            self.lcd.move(510, 50)
            self.message.move(517, 90)
            self.toolbar.setIconSize(QtCore.QSize(51,35))
            self.Maximize.setStatusTip("Enlarge")
            self.Maximize.setToolTip("Enlarge")
...
def Main():
    ...
    CamIP = "192.168.1.10"
    windowTitle = CamIP
    window = Window(windowTitle,CamIP,timeDuaration=100)
    sys.exit(App.exec())
